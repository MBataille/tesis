...
to the Jacobian in Newton's method, the stability of the solution can be tracked and bifurcation points 
can be detected by tracking changes in the sign of the determinant of the Jacobian.
...
the previous solution $\bm{u_0}$ as initial guess for Newton's method. Finally, the process is repeated
