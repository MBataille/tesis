...
The normal form can be written in a compact form as a complex equation: Eq.~(\ref{eq:hopf}). It is important to mention that
...
bifurcation point $\eta_c$, the amplitude of the limit close grows with $\sqrt{\eta - \eta_c}$ and the frequency is approximately
