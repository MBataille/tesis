...
\begin{enumerate}
    \item Soliton is a nonlinear localized wave that propagates while maintaining its shape
    and (usually) the amplitude.
    \item  Originally, they were discovered and described in conservative and integrable
    systems (KdV, NLS), in which case they arise due to a balance between dispersion and nonlinearity.
    \item Later, the term dissipative soliton was coined to describe a similar localized state
    ...
    of solitons.
    \item In what follows, we will refer to dissipative solitons as solitons for the sake
    of simplicity.
\end{enumerate}

[def soliton in integrable conservative system, KdV shallow water etc, NLS]
